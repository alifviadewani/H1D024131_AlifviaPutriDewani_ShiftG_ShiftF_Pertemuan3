...
# 1. Definisi Variabel Antecedent (Input) dan Consequent (Output) [cite: 8, 10]
...
# 2. Membership Functions (Sesuai Tabel Hal. 1 & 2) [cite: 12, 14]
...
# 3. Definisi Aturan (Rules Hal. 2) [cite: 16, 17, 18, 19, 20, 21]
...
# 5. Input Nilai Sesuai Soal [cite: 22]
